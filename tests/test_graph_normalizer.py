...
print(f"[TEST] Loaded {len(df)} lines")
print("[INPUT]")
print(df.to_string(index=False))

print("\n[RUNNING normalize_dataframe()] ...")

from core.graph_normalizer import BRANDS
print("finlandia" in BRANDS)
print(BRANDS.get("finlandia"))

try:
    df_norm = normalize_dataframe(df, col_name="Наименование")
    print("\n[OUTPUT]")
